...
public class Parcial {
     ...
     private static void CargaMatriz(){
        for (int c=0; c<vendedores.length;c++){
          for (int f=0; f< vendedores.length;f++){
              vendedores[0][0]="Donaldson Segura";
              vendedores[1][0]="Nancy Lopez";
              vendedores[2][0]="Carlos Menendez";
              vendedores[3][0]="Ever Flores";
              vendedores[4][0]="Magdalena Sandoval";
  ...
  public static void TotalARecibir(){
        ...
        System.out.println("El vendedor que recibio mas: " + y);
    }
